...
var _crypto =
/*#__PURE__*/
_interop_require_default(require("crypto"));
...
function hasContentChanged(sourcePath, root) {
  var css = root.toString(); // We only care about files with @tailwind directives
  ...
  var existingHash = _sharedState.sourceHashMap.get(sourcePath);

  var rootHash = getHash(css);
  var didChange = existingHash !== rootHash;
