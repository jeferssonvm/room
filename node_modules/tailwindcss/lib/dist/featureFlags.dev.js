...
_export(exports, {
  flagEnabled: function flagEnabled() {
    return _flagEnabled;
  },
  issueFlagNotices: function issueFlagNotices() {
    return _issueFlagNotices;
  },
...
function _flagEnabled(config, flag) {
...
function _issueFlagNotices(config) {
  ...
  if (experimentalFlagsEnabled(config).length > 0) {
    var changes = experimentalFlagsEnabled(config).map(function (s) {
      return _picocolors["default"].yellow(s);
    }).join(", ");
