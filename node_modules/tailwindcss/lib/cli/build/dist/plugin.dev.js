...
var _resolveConfig =
/*#__PURE__*/
_interop_require_default(require("../../../resolveConfig.js"));

var _content = require("../../lib/content.js");

var _watching = require("./watching.js");

var _fastglob =
/*#__PURE__*/
_interop_require_default(require("fast-glob"));

var _findAtConfigPath = require("../../lib/findAtConfigPath.js");
...
var state = {
  ...
  refreshConfigDependencies: function refreshConfigDependencies() {
    var _this_configBag;
    ...
    while (1) {
      switch (_context10.prev = _context10.next) {
        ...
        case 15:
          ...
          plugins = [].concat(_toConsumableArray(beforePlugins), [tailwindPlugin, !args["--minify"] && _utils.formatNodes], _toConsumableArray(afterPlugins), [!args["--no-autoprefixer"] && (0, _deps.loadAutoprefixer)(), args["--minify"] && (0, _deps.loadCssNano)()]).filter(Boolean);
