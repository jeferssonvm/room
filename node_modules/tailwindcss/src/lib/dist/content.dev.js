...
exports.parseCandidateFiles = parseCandidateFiles;
exports.resolvedChangedContent = resolvedChangedContent;
...
function resolveRelativePaths(context, contentPaths) {
  ...
  return contentPaths.map(function (contentPath) {
    contentPath.base = _path["default"].resolve.apply(_path["default"], _toConsumableArray(resolveFrom).concat([contentPath.base]));
    return contentPath;
  });
}
/**
