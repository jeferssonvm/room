...
var _isIdentifier = _interopRequireDefault(require("../util/isIdentifier"));
...
function (_Transformer) {
  _inherits(TypeScriptTransformer, _Transformer);
    ...
    value: function extractEnumKeyInfo(nameToken) {
      if (nameToken.type === _types.TokenType.name) {
        ...
        return {
          ...
          variableName: (0, _isIdentifier["default"])(_name) ? _name : null
        };
      } else {
