...
function (_Transformer) {
  _inherits(OptionalCatchBindingTransformer, _Transformer);

  function OptionalCatchBindingTransformer(tokens, nameManager) {
    var _this;

    _classCallCheck(this, OptionalCatchBindingTransformer);

    _this = _possibleConstructorReturn(this, _getPrototypeOf(OptionalCatchBindingTransformer).call(this));
    _this.tokens = tokens;
  ...
  _createClass(OptionalCatchBindingTransformer, [{
    key: "process",
