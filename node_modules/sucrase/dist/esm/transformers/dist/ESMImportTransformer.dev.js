...
var _elideImportEquals = _interopRequireDefault(require("../util/elideImportEquals"));

var _getDeclarationInfo = _interopRequireWildcard(require("../util/getDeclarationInfo"));

var _getImportExportSpecifierInfo = _interopRequireDefault(require("../util/getImportExportSpecifierInfo"));

var _getNonTypeIdentifiers = require("../util/getNonTypeIdentifiers");

var _isExportFrom = _interopRequireDefault(require("../util/isExportFrom"));

var _removeMaybeImportAttributes = require("../util/removeMaybeImportAttributes");

var _shouldElideDefaultExport = _interopRequireDefault(require("../util/shouldElideDefaultExport"));
...
function (_Transformer) {
  _inherits(ESMImportTransformer, _Transformer);
  ...
  function ESMImportTransformer(tokens, nameManager, helperManager, reactHotLoaderTransformer, isTypeScriptTransformEnabled, isFlowTransformEnabled, keepUnusedImports, options) {
    ...
    ;
    _this.nonTypeIdentifiers = isTypeScriptTransformEnabled && !keepUnusedImports ? (0, _getNonTypeIdentifiers.getNonTypeIdentifiers)(tokens, options) : new Set();
    _this.declarationInfo = isTypeScriptTransformEnabled && !keepUnusedImports ? (0, _getDeclarationInfo["default"])(tokens) : _getDeclarationInfo.EMPTY_DECLARATION_INFO;
  ...
  _createClass(ESMImportTransformer, [{
    ...
    value: function removeImportTypeBindings() {
      ...
      if (this.tokens.matches1(_types.TokenType.star)) {
        ...
        while (!this.tokens.matches1(_types.TokenType.braceR)) {
          ...
          var specifierInfo = (0, _getImportExportSpecifierInfo["default"])(this.tokens);
    ...
    value: function processNamedExports() {
      ...
      var isReExport = (0, _isExportFrom["default"])(this.tokens);
