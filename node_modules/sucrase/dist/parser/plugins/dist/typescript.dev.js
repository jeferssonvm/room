...
function tsNextTokenCanFollowModifier() {
  ...
  var canFollowModifier = (_index.match.call(void 0, _types.TokenType.bracketL) || _index.match.call(void 0, _types.TokenType.braceL) || _index.match.call(void 0, _types.TokenType.star) || _index.match.call(void 0, _types.TokenType.ellipsis) || _index.match.call(void 0, _types.TokenType.hash) || isLiteralPropertyName()) && !_util.hasPrecedingLineBreak.call(void 0);
...
function tsParseTypeParameter() {
  ...
  var hadIn = _index.eat.call(void 0, _types.TokenType._in);

  var hadOut = _util.eatContextual.call(void 0, _keywords.ContextualKeyword._out);
...
function tsParseTypeParameters() {
  var oldIsType = _index.pushTypeContext.call(void 0, 0);
...
function tsFillSignature(returnToken) {
  ...
  _util.expect.call(void 0, _types.TokenType.parenL); // Create a scope even though we're doing type parsing so we don't accidentally
...
function tsIsUnambiguouslyIndexSignature() {
  ...
  var isIndexSignature = _index.eat.call(void 0, _types.TokenType.name) && _index.match.call(void 0, _types.TokenType.colon);
...
function tsParseTypeMember() {
  ...
  if ((_util.isContextual.call(void 0, _keywords.ContextualKeyword._get) || _util.isContextual.call(void 0, _keywords.ContextualKeyword._set)) && tsNextTokenCanFollowModifier()) {// This is a getter/setter on a type. The tsNextTokenCanFollowModifier
...
function tsParseTemplateLiteralType() {
  // Finish `, read quasi
  _index.nextTemplateToken.call(void 0); // Finish quasi, read ${
  ...
  while (!_index.match.call(void 0, _types.TokenType.backQuote) && !_base.state.error) {
    ...
    _index.nextTemplateToken.call(void 0); // Finish quasi, read either ${ or `
...
function tsParseType() {
  ...
  _util.expect.call(void 0, _types.TokenType.question); // true type


  tsParseType();

  _util.expect.call(void 0, _types.TokenType.colon); // false type
...
function tsParseTypeAssertion() {
  var oldIsType = _index.pushTypeContext.call(void 0, 1);
...
function tsParseModuleBlock() {
  ...
  _statement.parseBlockBody.call(void 0,
  /* end */
...
function tsTryParseDeclare() {
  ...
  switch (_base.state.type) {
    case _types.TokenType._function:
      {
        ...
        _index.next.call(void 0); // We don't need to precisely get the function start here, since it's only used to mark
    ...
    case _types.TokenType._class:
      {
        var _oldIsType = _index.pushTypeContext.call(void 0, 1);

        _statement.parseClass.call(void 0,
        /* isStatement */
        true,
        /* optionalId */
        false);

        _index.popTypeContext.call(void 0, _oldIsType);
    ...
    case _types.TokenType._const:
      {
        if (_index.match.call(void 0, _types.TokenType._const) && _util.isLookaheadContextual.call(void 0, _keywords.ContextualKeyword._enum)) {
          var _oldIsType2 = _index.pushTypeContext.call(void 0, 1); // `const enum = 0;` not allowed because "enum" is a strict mode reserved word.
          ...
          _index.popTypeContext.call(void 0, _oldIsType2);
    ...
    case _types.TokenType._let:
      {
        var _oldIsType3 = _index.pushTypeContext.call(void 0, 1);

        _statement.parseVarStatement.call(void 0, _base.state.type !== _types.TokenType._var);

        _index.popTypeContext.call(void 0, _oldIsType3);
    ...
    case _types.TokenType.name:
      {
        var _oldIsType4 = _index.pushTypeContext.call(void 0, 1);
        ...
        _index.popTypeContext.call(void 0, _oldIsType4);
  ...
  switch (contextualKeyword) {
    ...
    case _keywords.ContextualKeyword._interface:
      if (tsCheckLineTerminator(isBeforeToken) && _index.match.call(void 0, _types.TokenType.name)) {
        ...
        // as well.
        var oldIsType = _index.pushTypeContext.call(void 0, isBeforeToken ? 2 : 1);
    ...
    case _keywords.ContextualKeyword._module:
      if (tsCheckLineTerminator(isBeforeToken)) {
        if (_index.match.call(void 0, _types.TokenType.string)) {
          var _oldIsType5 = _index.pushTypeContext.call(void 0, isBeforeToken ? 2 : 1);

          tsParseAmbientExternalModuleDeclaration();

          _index.popTypeContext.call(void 0, _oldIsType5);

          return true;
        } else if (_index.match.call(void 0, _types.TokenType.name)) {
          var _oldIsType6 = _index.pushTypeContext.call(void 0, isBeforeToken ? 2 : 1);

          tsParseModuleOrNamespaceDeclaration();

          _index.popTypeContext.call(void 0, _oldIsType6);
    ...
    case _keywords.ContextualKeyword._namespace:
      if (tsCheckLineTerminator(isBeforeToken) && _index.match.call(void 0, _types.TokenType.name)) {
        var _oldIsType7 = _index.pushTypeContext.call(void 0, isBeforeToken ? 2 : 1);

        tsParseModuleOrNamespaceDeclaration();

        _index.popTypeContext.call(void 0, _oldIsType7);
    ...
    case _keywords.ContextualKeyword._type:
      if (tsCheckLineTerminator(isBeforeToken) && _index.match.call(void 0, _types.TokenType.name)) {
        var _oldIsType8 = _index.pushTypeContext.call(void 0, isBeforeToken ? 2 : 1);

        tsParseTypeAliasDeclaration();

        _index.popTypeContext.call(void 0, _oldIsType8);
...
function tsTryParseExport() {
  if (_index.eat.call(void 0, _types.TokenType._import)) {
    ...
    if (_util.isContextual.call(void 0, _keywords.ContextualKeyword._type)) {
      var nextType = _index.lookaheadType.call(void 0); // export type {foo} from 'a';
      // export type * from 'a';'
...
function tsParseImportSpecifier() {
  ...
  _expression.parseIdentifier.call(void 0); // import {type foo as bar}
...
function tsParseExportSpecifier() {
  ...
  _expression.parseIdentifier.call(void 0); // export {type foo as bar}
...
function tsTryParseExportDefaultExpression() {
  ...
  if (_util.isContextual.call(void 0, _keywords.ContextualKeyword._interface)) {
    ...
    var oldIsType = _index.pushTypeContext.call(void 0, 2);
...
function tsTryParseStatementContent() {
  if (_base.state.type === _types.TokenType._const) {
    var ahead = _index.lookaheadTypeAndKeyword.call(void 0);
...
exports.tsTryParseClassMemberWithIsStatic = tsTryParseClassMemberWithIsStatic; // Note: The reason we do this in `parseIdentifierStatement` and not `parseStatement`
...
function tsParseExportDeclaration() {
  ...
  var isDeclare = _util.eatContextual.call(void 0, _keywords.ContextualKeyword._declare);
  ...
  if (!matchedDeclaration) {
    if (isDeclare) {
      var _oldIsType9 = _index.pushTypeContext.call(void 0, 2);

      _statement.parseStatement.call(void 0, true);

      _index.popTypeContext.call(void 0, _oldIsType9);
    } else {
      _statement.parseStatement.call(void 0, true);
    }
  }
...
exports.tsStartParseFunctionParams = tsStartParseFunctionParams; // `let x: number;`
...
exports.tsAfterParseVarHead = tsAfterParseVarHead; // parse the return type of an async arrow function - let foo = (async (): number => {});
...
exports.tsStartParseAsyncArrowFromCallExpression = tsStartParseAsyncArrowFromCallExpression; // Returns true if the expression was an arrow function.
...
function tsParseMaybeAssignWithJSX(noIn, isWithinParens) {
  ...
  var wasArrow = _expression.baseParseMaybeAssign.call(void 0, noIn, isWithinParens);
...
exports.tsParseArrow = tsParseArrow; // Allow type annotations inside of a parameter list.
