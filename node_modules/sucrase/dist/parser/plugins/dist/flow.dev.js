...
function flowParseTypeParameterDeclaration() {
  var oldIsType = _index.pushTypeContext.call(void 0, 0); // istanbul ignore else: this condition is already checked at all call sites
...
function flowParseObjectType(allowStatic, allowExact, allowProto) {
  ...
  while (!_index.match.call(void 0, endDelim) && !_base.state.error) {
    if (allowProto && _util.isContextual.call(void 0, _keywords.ContextualKeyword._proto)) {
      var lookahead = _index.lookaheadType.call(void 0);
    ...
    if (allowStatic && _util.isContextual.call(void 0, _keywords.ContextualKeyword._static)) {
      var _lookahead = _index.lookaheadType.call(void 0);
    ...
    if (_index.eat.call(void 0, _types.TokenType.bracketL)) {
      ...
      if (_util.isContextual.call(void 0, _keywords.ContextualKeyword._get) || _util.isContextual.call(void 0, _keywords.ContextualKeyword._set)) {
        var _lookahead2 = _index.lookaheadType.call(void 0);
...
function flowParseTupleType() {
  _util.expect.call(void 0, _types.TokenType.bracketL); // We allow trailing commas
...
function flowParsePrimaryType() {
  ...
  switch (_base.state.type) {
    ...
    case _types.TokenType.parenL:
      _index.next.call(void 0); // Check to see if this is actually a grouped type
      ...
      if (!_index.match.call(void 0, _types.TokenType.parenR) && !_index.match.call(void 0, _types.TokenType.ellipsis)) {
        if (_index.match.call(void 0, _types.TokenType.name)) {
          var token = _index.lookaheadType.call(void 0);
...
function flowParsePostfixType() {
  ...
  while (!_util.canInsertSemicolon.call(void 0) && (_index.match.call(void 0, _types.TokenType.bracketL) || _index.match.call(void 0, _types.TokenType.questionDot))) {
    ...
    if (_index.eat.call(void 0, _types.TokenType.bracketR)) {// Array type
    } else {
      // Indexed access type
      flowParseType();
...
exports.flowStartParseNewArguments = flowStartParseNewArguments; // interfaces
...
exports.flowTryParseExportDefaultExpression = flowTryParseExportDefaultExpression; // declares, interfaces and type aliases
...
function flowParseIdentifierStatement(contextualKeyword) {
  if (contextualKeyword === _keywords.ContextualKeyword._declare) {
    ...
    if (contextualKeyword === _keywords.ContextualKeyword._interface) {
      ...
      var _oldIsType2 = _index.pushTypeContext.call(void 0, 1);
...
exports.flowParseIdentifierStatement = flowParseIdentifierStatement; // export type
...
function flowParseExportDeclaration() {
  if (_util.isContextual.call(void 0, _keywords.ContextualKeyword._type)) {
    ...
    _index.next.call(void 0); // export opaque type Foo = Bar;
    ...
    var _oldIsType5 = _index.pushTypeContext.call(void 0, 1);
...
exports.flowParseExportStar = flowParseExportStar; // parse a the super class type parameters and implements
...
exports.flowAfterParseClassSuper = flowAfterParseClassSuper; // parse type parameters for object method shorthand
...
exports.flowParseAssignableListItemTypes = flowParseAssignableListItemTypes; // parse typeof and type imports
...
function flowStartParseImportSpecifiers() {
  if (_index.match.call(void 0, _types.TokenType._typeof) || _util.isContextual.call(void 0, _keywords.ContextualKeyword._type)) {
    var lh = _index.lookaheadTypeAndKeyword.call(void 0);
...
exports.flowStartParseImportSpecifiers = flowStartParseImportSpecifiers; // parse import-type/typeof shorthand
...
function flowParseImportSpecifier() {
  ...
  if (_util.isContextual.call(void 0, _keywords.ContextualKeyword._as) && !_util.isLookaheadContextual.call(void 0, _keywords.ContextualKeyword._as)) {
    ...
    if (isTypeKeyword && !_index.match.call(void 0, _types.TokenType.name) && !(_base.state.type & _types.TokenType.IS_KEYWORD)) {// `import {type as ,` or `import {type as }`
    } else {
      // `import {type as foo`
      _expression.parseIdentifier.call(void 0);
    }
...
exports.flowParseImportSpecifier = flowParseImportSpecifier; // parse function type parameters - function foo<T>() {}
...
exports.flowStartParseFunctionParams = flowStartParseFunctionParams; // parse flow type annotations on variable declarator heads - let foo: string = bar
...
exports.flowAfterParseVarHead = flowAfterParseVarHead; // parse the return type of an async arrow function - let foo = (async (): number => {});
...
exports.flowStartParseAsyncArrowFromCallExpression = flowStartParseAsyncArrowFromCallExpression; // We need to support type parameter declarations for arrow functions. This
...
exports.flowParseMaybeAssign = flowParseMaybeAssign; // handle return types for arrow functions
...
exports.flowParseSubscripts = flowParseSubscripts; // Returns true if there was an arrow function here.
