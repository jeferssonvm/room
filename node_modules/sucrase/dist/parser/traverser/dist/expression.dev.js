...
exports.StopState = StopState; // ### Expression parsing
...
exports.parseMaybeAssign = parseMaybeAssign; // Parse an assignment expression. This includes applications of
// operators like `+=`.
...
exports.baseParseMaybeAssign = baseParseMaybeAssign; // Parse a ternary conditional (`?:`) operator.
// Returns true if the expression was an arrow function.
...
exports.baseParseConditional = baseParseConditional; // Start the precedence parser.
...
function parseExprOp(startTokenIndex, minPrec, noIn) {
  if (_base.isTypeScriptEnabled && (_types3.TokenType._in & _types3.TokenType.PRECEDENCE_MASK) > minPrec && !_util.hasPrecedingLineBreak.call(void 0) && (_util.eatContextual.call(void 0, _keywords.ContextualKeyword._as) || _util.eatContextual.call(void 0, _keywords.ContextualKeyword._satisfies))) {
    var oldIsType = _index3.pushTypeContext.call(void 0, 1);
  ...
  var prec = _base.state.type & _types3.TokenType.PRECEDENCE_MASK;
...
exports.parseMaybeUnary = parseMaybeUnary; // Parse call, dot, and `[]`-subscript expressions.
// Returns true if this was an arrow function.
...
function baseParseSubscript(startTokenIndex, noCalls, stopState) {
  if (!noCalls && _index3.eat.call(void 0, _types3.TokenType.doubleColon)) {
    ...
    if (atPossibleAsync()) {
      ...
      var callContextId = _base.getNextContextId.call(void 0);
      ...
      var _callContextId = _base.getNextContextId.call(void 0);
...
function parseExprAtom() {
  ...
  switch (_base.state.type) {
    ...
    case _types3.TokenType.name:
      {
        ...
        if (contextualKeyword === _keywords.ContextualKeyword._await) {
          ...
          _util.expect.call(void 0, _types3.TokenType.arrow); // let foo = async bar => {};
    ...
    case _types3.TokenType.hash:
      {
        var code = _index3.lookaheadCharCode.call(void 0);
...
exports.parseParenExpression = parseParenExpression; // Returns true if this was an arrow expression.
...
function parseTemplate() {
  // Finish `, read quasi
  _index3.nextTemplateToken.call(void 0); // Finish quasi, read ${
  ...
  while (!_index3.match.call(void 0, _types3.TokenType.backQuote) && !_base.state.error) {
    ...
    _index3.nextTemplateToken.call(void 0); // Finish quasi, read either ${ or `
...
exports.parseTemplate = parseTemplate; // Parse an object literal or binding pattern.

function parseObj(isPattern, isBlockScope) {
  // Attach a context ID to the object open and close brace and each object key.
  var contextId = _base.getNextContextId.call(void 0);
  ...
  while (!_index3.eat.call(void 0, _types3.TokenType.braceR) && !_base.state.error) {
    ...
    if (!isPattern && _util.isContextual.call(void 0, _keywords.ContextualKeyword._async)) {
      ...
      if (_index3.match.call(void 0, _types3.TokenType.colon) || _index3.match.call(void 0, _types3.TokenType.parenL) || _index3.match.call(void 0, _types3.TokenType.braceR) || _index3.match.call(void 0, _types3.TokenType.eq) || _index3.match.call(void 0, _types3.TokenType.comma)) {// This is a key called "async" rather than an async function.
      } else {
...
exports.parsePropertyName = parsePropertyName; // Parse object or class method.

function parseMethod(functionStart, isConstructor) {
  var funcContextId = _base.getNextContextId.call(void 0);
...
exports.parseMethod = parseMethod; // Parse arrow function expression.
...
function parseFunctionBody(allowExpression) {
  var funcContextId = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 0;
  var isExpression = allowExpression && !_index3.match.call(void 0, _types3.TokenType.braceL);

  if (isExpression) {
    parseMaybeAssign();
  } else {
    _statement.parseBlock.call(void 0, true
    /* isFunctionScope */
    , funcContextId);
  }
}

exports.parseFunctionBody = parseFunctionBody; // Parses a comma-separated list of expressions, and returns them as
...
function parseExprListItem(allowEmpty) {
  if (allowEmpty && _index3.match.call(void 0, _types3.TokenType.comma)) {// Empty item; nothing more to parse for this item.
...
exports.parseIdentifier = parseIdentifier; // Parses await expression inside async function.
...
function parseModuleExpression() {
  ...
  _util.expect.call(void 0, _types3.TokenType.braceL); // For now, just call parseBlockBody to parse the block. In the future when we
