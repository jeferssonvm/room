...
exports.markPriorBindingIdentifier = markPriorBindingIdentifier; // Parses lvalue (assignable) atom.
...
function parseBindingList(close, isBlockScope) {
  ...
  while (!_index.eat.call(void 0, close) && !_base.state.error) {
    ...
    if (allowEmpty && _index.match.call(void 0, _types.TokenType.comma)) {// Empty item; nothing further to parse for this item.
