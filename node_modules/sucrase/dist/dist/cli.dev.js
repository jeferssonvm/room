    ...
    while (1) {
      switch (_context2.prev = _context2.next) {
        case 0:
          ...
          _context2.next = 5;
          return regeneratorRuntime.awrap(_fs.exists.call(void 0, outDirPath));
        ...
        case 5:
          ...
          _context2.next = 8;
          return regeneratorRuntime.awrap(_fs.mkdir.call(void 0, outDirPath));
        ...
        case 8:
            ...
            return regeneratorRuntime.async(function _loop$(_context) {
              while (1) {
                switch (_context.prev = _context.next) {
                  ...
                  case 3:
                    srcChildPath = _path.join.call(void 0, srcDirPath, child);
                    outChildPath = _path.join.call(void 0, outDirPath, child);
                    _context.next = 7;
                    return regeneratorRuntime.awrap(_fs.stat.call(void 0, srcChildPath));
          ...
          _context2.next = 16;
          return regeneratorRuntime.awrap(_fs.readdir.call(void 0, srcDirPath));
  ...
  return regeneratorRuntime.async(function runGlob$(_context3) {
    while (1) {
      switch (_context3.prev = _context3.next) {
        case 0:
          tsConfigPath = _path.join.call(void 0, options.project, "tsconfig.json");
          _context3.prev = 1;
          _context3.next = 4;
          return regeneratorRuntime.awrap(_fs.readFile.call(void 0, tsConfigPath, "utf8"));
        ...
        case 13:
          ...
          absProject = _path.join.call(void 0, process.cwd(), options.project);
          outDirs = [];
          _context3.next = 21;
          return regeneratorRuntime.awrap(_fs.exists.call(void 0, options.outDirPath));
        ...
        case 21:
          ...
          _context3.next = 24;
          return regeneratorRuntime.awrap(_fs.mkdir.call(void 0, options.outDirPath));
        ...
        case 36:
          srcFile = _path.join.call(void 0, absProject, file);
          outFile = _path.join.call(void 0, options.outDirPath, file);
          outPath = outFile.replace(/\.\w+$/, ".".concat(options.outExtension));
          outDir = _path.dirname.call(void 0, outPath);
        ...
        case 65:
          ...
          _context3.next = 69;
          return regeneratorRuntime.awrap(glob(_path.join.call(void 0, absProject, pattern)));
        ...
        case 81:
          relativeFile = _path.relative.call(void 0, absProject, _file);
          _outFile = _path.join.call(void 0, options.outDirPath, relativeFile);
          _outPath = _outFile.replace(/\.\w+$/, ".".concat(options.outExtension));
          _outDir = _path.dirname.call(void 0, _outPath);
        ...
        case 122:
          ...
          _context3.next = 126;
          return regeneratorRuntime.awrap(_fs.exists.call(void 0, _outDirPath));
        ...
        case 126:
          ...
          _context3.next = 129;
          return regeneratorRuntime.awrap(_fs.mkdir.call(void 0, _outDirPath));
    ...
    while (1) {
      switch (_context6.prev = _context6.next) {
        case 0:
          ...
          _context6.next = 3;
          return regeneratorRuntime.awrap(_fs.readFile.call(void 0, srcPath));

        case 3:
          code = _context6.sent.toString();
          transformedCode = _index.transform.call(void 0, code, _objectSpread({}, options.sucraseOptions, {
            filePath: srcPath
          })).code;
          _context6.next = 7;
          return regeneratorRuntime.awrap(_fs.writeFile.call(void 0, outPath, transformedCode));
