...
function formatTokens(code, tokens) {
  ...
  var lines = new (0, _linesandcolumns2["default"])(code);
  ...
  function getTokenComponents(token) {
    ...
    return [formatRange(token.start, token.end), _types.formatTokenType.call(void 0, token.type), truncate(String(raw), 14)].concat(_toConsumableArray(tokenKeys.map(function (key) {
