...
function (_Transformer2$default) {
  _inherits(NumericSeparatorTransformer, _Transformer2$default);

  function NumericSeparatorTransformer(tokens) {
    var _this;

    _classCallCheck(this, NumericSeparatorTransformer);

    _this = _possibleConstructorReturn(this, _getPrototypeOf(NumericSeparatorTransformer).call(this));
    _this.tokens = tokens;
    ;
    return _this;
  }

  _createClass(NumericSeparatorTransformer, [{
    key: "process",
