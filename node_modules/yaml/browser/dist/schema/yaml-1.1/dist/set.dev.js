...
function (_YAMLMap) {
  ...
  _createClass(YAMLSet, [{
    ...
    value: function add(key) {
      var pair;
      if ((0, _identity.isPair)(key)) pair = key;else if (key && _typeof(key) === 'object' && 'key' in key && 'value' in key && key.value === null) pair = new _Pair.Pair(key.key, null);else pair = new _Pair.Pair(key, null);
