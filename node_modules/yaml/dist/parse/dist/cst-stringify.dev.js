    ...
    case 'flow-collection':
      {
        ...
        try {
          for (var _iterator3 = token.items[Symbol.iterator](), _step3; !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {
    ...
    default:
      {
        ...
        if ('end' in token && token.end) {
          ...
          try {
            for (var _iterator6 = token.end[Symbol.iterator](), _step6; !(_iteratorNormalCompletion6 = (_step6 = _iterator6.next()).done); _iteratorNormalCompletion6 = true) {
...
function stringifyItem(_ref) {
  ...
  try {
    for (var _iterator7 = start[Symbol.iterator](), _step7; !(_iteratorNormalCompletion7 = (_step7 = _iterator7.next()).done); _iteratorNormalCompletion7 = true) {
  ...
  if (sep) {
    ...
    try {
      for (var _iterator8 = sep[Symbol.iterator](), _step8; !(_iteratorNormalCompletion8 = (_step8 = _iterator8.next()).done); _iteratorNormalCompletion8 = true) {
        var st = _step8.value;
        res += st.source;
      }
    } catch (err) {
