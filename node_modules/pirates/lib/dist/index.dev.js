...
var nodeModulesRegex = /^(?:.*[\\/])?node_modules(?:[\\/].*)?$/; // Guard against poorly mocked module constructors.

var Module = module.constructor.length > 1 ? module.constructor : _module["default"];
...
function addHook(hook) {
  ...
  var loaders = [];
  var oldLoaders = [];
  var exts; // We need to do this to fix #15. Basically, if you use a non-standard extension (ie. .jsx), then
  ...
  exts.forEach(function (ext) {
    if (typeof ext !== 'string') {
      throw new TypeError("Invalid Extension: ".concat(ext));
    }
