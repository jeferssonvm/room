...
Command.prototype.action = function (fn) {
  ...
  var listener = function listener(args, unknown) {
    ...
    var actionResult = fn.apply(self, actionArgs); // Remember result in case it is async. Assume parseAsync getting called on root.
...
Command.prototype.normalize = function (args) {
  ...
  for (var i = 0, len = args.length; i < len; ++i) {
    ...
    if (arg === '--') {
      ...
      _short = arg.slice(0, 2);
      opt = this.optionFor(_short);
...
Command.prototype.variadicArgNotLast = function (name) {
  var message = "error: variadic arguments must be last '".concat(name, "'");
  console.error(message);
