...
!function (e) {
  var t;
  "object" == (typeof exports === "undefined" ? "undefined" : _typeof(exports)) ? module.exports = e() : "function" == typeof define && define.amd ? define(e) : ("undefined" != typeof window ? t = window : "undefined" != typeof global ? t = global : "undefined" != typeof self && (t = self), t.objectHash = e());
}(function () {
      ...
      !function (e, n, s, c, d, h, p, g, y) {
        ...
        function u(e, t) {
          ...
          for (var r = 0; r < o.length; ++r) {
            o[r].toLowerCase() === n.algorithm.toLowerCase() && (n.algorithm = o[r]);
          }
      ...
      !function (e, t, n, r, o, i, u, s, a) {
        !function (e) {
          ...
          e.toByteArray = function (e) {
            ...
            for (t = 0; t < i; t += 4, 0) {
              s((16711680 & (n = f(e.charAt(t)) << 18 | f(e.charAt(t + 1)) << 12 | f(e.charAt(t + 2)) << 6 | f(e.charAt(t + 3)))) >> 16), s((65280 & n) >> 8), s(255 & n);
            }
            ...
            for (t = 0, r = e.length - i; t < r; t += 3) {
              n = (e[t] << 16) + (e[t + 1] << 8) + e[t + 2], u += s((o = n) >> 18 & 63) + s(o >> 12 & 63) + s(o >> 6 & 63) + s(63 & o);
            }
    ...
    3: [function (O, e, H) {
      !function (e, n, f, r, h, p, g, y, w) {
        ...
        function f(e, t, n) {
          ...
          if ("base64" === t && "string" == s) for (e = (u = e).trim ? u.trim() : u.replace(/^\s+|\s+$/g, ""); e.length % 4 != 0;) {
            e += "=";
          }
          ...
          if (f._useTypedArrays ? o = f._augment(new Uint8Array(r)) : ((o = this).length = r, o._isBuffer = !0), f._useTypedArrays && "number" == typeof e.byteLength) o._set(e);else if (C(u = e) || f.isBuffer(u) || u && "object" == _typeof(u) && "number" == typeof u.length) for (i = 0; i < r; i++) {
            f.isBuffer(e) ? o[i] = e.readUInt8(i) : o[i] = e[i];
          } else if ("string" == s) o.write(e, 0, t);else if ("number" == s && !f._useTypedArrays && !n) for (i = 0; i < r; i++) {
            o[i] = 0;
          }
          return o;
        }
        ...
        function m(e, t, n, r) {
          return f._charsWritten = c(function (e) {
            for (var t, n, r = [], o = 0; o < e.length; o++) {
              n = e.charCodeAt(o), t = n >> 8, n = n % 256, r.push(n), r.push(t);
            }
        ...
        function s(e, t, n, r, o) {
          ...
          o = e.length;
          if (!(o <= n)) for (var i = 0, u = Math.min(o - n, 2); i < u; i++) {
        ...
        function l(e, t, n, r, o) {
          ...
          o = e.length;
          if (!(o <= n)) for (var i = 0, u = Math.min(o - n, 4); i < u; i++) {
          ...
          switch (e) {
            ...
            case "utf-8":
              r = function (e, t, n) {
                ...
                for (var i = t; i < n; i++) {
                  e[i] <= 127 ? (r += N(o) + String.fromCharCode(e[i]), o = "") : o += "%" + e[i].toString(16);
                }
        ...
        function T(e) {
          for (var t = [], n = 0; n < e.length; n++) {
            ...
            if (r <= 127) t.push(e.charCodeAt(n));else for (var o = n, i = (55296 <= r && r <= 57343 && n++, encodeURIComponent(e.slice(o, n + 1)).substr(1).split("%")), u = 0; u < i.length; u++) {
        ...
        d.exports = {
          hash: function hash(e, t, n, r) {
            for (var o = t(function (e, t) {
              ...
              for (var n, r = [], o = t ? e.readInt32BE : e.readInt32LE, i = 0; i < e.length; i += f) {
                r.push(o.call(e, i));
              }

              return r;
            }(e = a.isBuffer(e) ? e : new a(e), r), 8 * e.length), t = r, i = new a(n), u = t ? i.writeInt32BE : i.writeInt32LE, s = 0; s < o.length; s++) {
              u.call(i, o[s], 4 * s, !0);
            }
          ...
          return r || i("algorithm:", e, "is not yet supported"), {
            ...
            digest: function digest(e) {
              var t = u.concat(o),
                ...
                for (var r = new u(s), o = new u(s), i = 0; i < s; i++) {
      ...
      !function (e, t, n, r, u, s, a, f, l) {
        ...
        function o(e, l) {
          ...
          for (var r, o, h = 0; h < e.length; h += 16) {
            for (var i = t[0], u = t[1], s = t[2], p = t[3], a = t[4], g = t[5], y = t[6], w = t[7], f = 0; f < 64; f++) {
              n[f] = f < 16 ? e[f + h] : b(b(b((o = n[f - 2], m(o, 17) ^ m(o, 19) ^ v(o, 10)), n[f - 7]), (o = n[f - 15], m(o, 7) ^ m(o, 18) ^ v(o, 3))), n[f - 16]), c = b(b(b(b(w, m(o = a, 6) ^ m(o, 11) ^ m(o, 25)), a & g ^ ~a & y), d[f]), n[f]), r = b(m(r = i, 2) ^ m(r, 13) ^ m(r, 22), i & u ^ i & s ^ u & s), w = y, y = g, g = a, a = b(p, c), p = s, s = u, u = i, i = b(c, r);
            }
